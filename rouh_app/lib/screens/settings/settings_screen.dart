                        ...
                        children: <Widget>[
                          Stack(
                            children: [
                              Container(
                                width: screenWidth,
                                height: (bodyHeight * 0.20 ) -MediaQuery.of(context).padding.top , // service list,
                              ),
                              Positioned(
                                left: 0,
                                right: 0,
                                    ...
                                    children: [
                                      Row(children: [
                                        Padding(
                                          padding: const EdgeInsets.all(5),
                                          child: SvgPicture.asset(
                                            "assets/svg/cart-black-icon.svg",
                                            color: myprimercolor,
                                            width: 25,
                                          ),
                                        ),
                                ...
                                Row(
                                  ...
                                  children: [
                                    Row(children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.all(5),
                                        child: Text("مركز الدعم والمساعدة",
                                          style: TextStyle(
                                              fontSize: 16,
                                              color: Colors.grey.shade400),
                                        ),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Row(children: [
                                        Padding(
                                          padding: const EdgeInsets.all(5),
                                          child: Image(image: AssetImage('assets/images/facebook-round-color-icon.png'),
                                            width: 25,
                                            height: 25,
                                            fit: BoxFit.cover,),
                                        ),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Row(children: [
                                        Padding(
                                          padding: const EdgeInsets.all(5),
                                          child: Image(image: AssetImage('assets/images/x-social-media-round-icon.png'),
                                          width: 25,
                                              height: 25,
                                              fit: BoxFit.cover,),
                                        ),
