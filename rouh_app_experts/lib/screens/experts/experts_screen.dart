...
import 'expert_info_screen.dart';
...
class _ExpertsScreenState extends State<ExpertsScreen> {
  ...
  void initState() {
    ...
    expertIdBloc = context.read<ExpertInformationCubit>().state.fetchedExpert!.id!;

    fillServiceList();
    print("expertIdBloc: " + expertIdBloc.toString());
    fillExpertList(expertIdBloc!);
  }
  ...
  Future<void> fillExpertList(int expertIdBloc) async {
    getGlobalExpertWithFavoriteList(expertIdBloc).then((response) {
      setState(() {
                      ...
                      child: GestureDetector(
                        onTap: () {
                          ...
                          globalExpert.SaveFavorite(
                            expertId: expertIdBloc,
                            selectExpertId: expert.id!,
